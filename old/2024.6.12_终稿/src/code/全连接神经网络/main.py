...
class TwoLayerNet:
    ...
    def compute_lyapunov_spectrum(self, x, num_perturbations=50):
        W1, W2 = self.params['W1'], self.params['W2']
        b1, b2 = self.params['b1'], self.params['b2']
    ...
    def compute_backprop_lyapunov_spectrum(self, x, t, num_perturbations=50):
        W1, W2 = self.params['W1'], self.params['W2']
        b1, b2 = self.params['b1'], self.params['b2']
        ...
        for _ in range(num_perturbations):
            perturbation = np.random.randn(*dy.shape) * 1e-4
            dy_perturbed = dy + perturbation

            da1_perturbed = np.dot(dy_perturbed, W2.T)
...
if __name__ == "__main__":
    ...
    # Compute Lyapunov spectrum for the hidden layer
    lyapunov_spectrum = network.compute_lyapunov_spectrum(x_batch)
    print("Lyapunov spectrum of hidden layer:", lyapunov_spectrum)

    # Compute Lyapunov spectrum for the backward propagation
    backprop_lyapunov_spectrum = network.compute_backprop_lyapunov_spectrum(x_batch, t_batch)
    print("Lyapunov spectrum of backward propagation:", backprop_lyapunov_spectrum)
